					...
					function fieldLink(scope, el, attrs, formlyFormCtrl) {
						...
						function setFieldGroupTemplate() {
							...
							if (scope.options.elementAttributes) {
								// Add class to fieldGroup inside fieldGroup [UniQ]
								if (scope.options.elementAttributes.formlyFieldGroupClass) {
									el.addClass(scope.options.elementAttributes.formlyFieldGroupClass);
								}
